...
p. Returning an array of something is also possible with the following construct @"[Ljava.lang.Object;"@. Need a 2-dim array? Just use @"[[Ljava.lang.Object;"@ (notice the extra @[@) and so on.
