...
**2)** Add a file called `LICENSE` in the root of your project with the following link:http://creativecommons.org/publicdomain/zero/1.0/legalcode.txt[legal code]:
